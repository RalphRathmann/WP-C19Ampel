...
function C19A_admin_menu() {
	...
	function C19ASettings() {
        ...
        echo "<br><div><br>
        <p>Besuchen Sie bitte die folgende Seite und wählen dort Ihren Landkreis aus.
        ...
        <br><p>Die OBJECTID aus der linken Spalte tragen Sie dann einfach hier im untenstehenden Formular ein:</p>
        </div><br>";
        ...
        echo "<br><div><small>Das Plugin ist auf Basis des Informationsstandes vom 25.04.2021 erstellt worden.<br>DB-Version: " . get_option( 'c19a_db_version') . "</small></div>";
